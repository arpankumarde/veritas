...
class VerificationQuestion:
    ...
    question: str
    aspect: str  # What aspect of the evidence this verifies (factual, temporal, source, etc.)
...
class VerificationResult:
    """Result of verifying a piece of evidence."""
            ...
            "contradictions": [
                {
                    ...
                    "conflicting_evidence_id": c.conflicting_evidence_id,
...
class BatchVerificationResult:
    """Result of batch verification of multiple pieces of evidence."""
    ...
    avg_time_per_evidence_ms: float = 0.0
    ...
    def get_high_confidence_evidence(self) -> list[VerificationResult]:
        """Get evidence with verified status (>85% confidence)."""
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "avg_time_per_evidence_ms": self.avg_time_per_evidence_ms,
        }
...
class VerificationConfig:
    ...
    parallel_batch_size: int = 5  # Process 5 pieces of evidence in parallel
